...
- (void)handleSingleTap {
    if ([delegate respondsToSelector:@selector(gotSingleTapAtPoint:)])
        [delegate gotSingleTapAtPoint:tapLocation];
}

- (void)handleDoubleTap {
    if ([delegate respondsToSelector:@selector(gotDoubleTapAtPoint:)])
        [delegate gotDoubleTapAtPoint:tapLocation];
}
    
- (void)handleTwoFingerTap {
    if ([delegate respondsToSelector:@selector(gotTwoFingerTapAtPoint:)])
        [delegate gotTwoFingerTapAtPoint:tapLocation];
}
